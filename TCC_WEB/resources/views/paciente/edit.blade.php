        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">EDITAR PACIENTE #{{ $paciente->id }}</div>
                    {{ Form::model($paciente, ['route' => ['paciente.update', $paciente], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <div class="img-responsive img-thumbnail" style="width: 100%; height: 143px">
                                        <img id="visualizar_img" src="{{ asset(!is_null($paciente->foto) ? 'upload/foto_paciente/'.$paciente->foto : 'sem_imagem.jpeg') }}" style="height: 100%; width: 100%" class="img-responsive img-thumbnail" />
                                    </div>
                                </div>
                            </div>
                        </div>
