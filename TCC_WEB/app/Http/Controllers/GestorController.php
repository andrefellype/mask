...
class GestorController extends Controller
{
    ...
    {
        $gestores = [];
        $gestoresTemp = User::where('nivel','GESTOR PACIENTE/PRESTADOR')->orwhere('nivel','GESTOR MOTORISTA')->orderBy('name')->get();
    ...
    {
        $gestores = ['GESTOR PACIENTE/PRESTADOR' => 'GESTOR PACIENTE/PRESTADOR', 'GESTOR MOTORISTA' => 'GESTOR MOTORISTA'];
        return View::make('gestor.create')->with('gestores', $gestores);
    }

    /**
     * Store a newly created resource in storage.
     *where('nivel','GESTOR PACIENTE')
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $usuario->nivel = Input::get('gestor');
            $usuario->save();
