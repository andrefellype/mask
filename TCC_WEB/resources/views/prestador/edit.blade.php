        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">EDITAR PRESTADOR #{{ $prestador->id }}</div>
                    {{ Form::model($prestador, ['route' => ['prestador.update', $prestador], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                    ...
                    <div class="panel-footer">
                        ...
                        <a href="{{ url('prestador') }}" class="btn btn-info pull-right">
                            VOLTAR
                        </a>
                    </div>
                    {{ Form::close() }}
